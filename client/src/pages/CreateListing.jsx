      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='discountdPrice' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg' />
              <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 dispabled:opacity-80'>Create listing</button>
        </div>
      </form>
    </main>
  )
