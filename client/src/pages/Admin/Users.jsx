  ...
  return (
    <div className='bg-gray-100 rounded p-5'>
      ...
      <div className='flex justify-between items-center border-b-[1px] pb-5'>
        <p className='text-lg font-bold'>Użytkownicy (38)</p>
        <div className='flex'>
            ...
            <div className='bg-white border-[1px] border-gray-200 p-5 rounded flex w-full'>
              <div className='w-1/3 flex flex-col items-center py-5 border-r-[1px] border-gray-200'>
                <img
                  src=''
                  alt='profile image'
                  className='rounded-full h-24 w-24 object-cover cursor-pointer mb-5 bg-black'
                />
                <p>User name</p>
                <p>Nr 001</p>
              ...
              <div className='w-2/3 px-5'>
                ...
                <span className='mb-3 flex'>
                  ...
                  <p className='text-orange-600 ml-1 cursor-pointer'>(0)</p>
                </span>
                <span className='mb-3 flex'>
